...
const getController = (db, self) => {
	...
	if (!controller) {
		...
		controllers.set(
			db,
			(controller = {
				default: { begin: db.prepare('BEGIN', self, false, false), ...shared },
				deferred: { begin: db.prepare('BEGIN DEFERRED', self, false, false), ...shared },
				immediate: { begin: db.prepare('BEGIN IMMEDIATE', self, false, false), ...shared },
				exclusive: { begin: db.prepare('BEGIN EXCLUSIVE', self, false, false), ...shared },
			}),
		);
	}
	return controller;
