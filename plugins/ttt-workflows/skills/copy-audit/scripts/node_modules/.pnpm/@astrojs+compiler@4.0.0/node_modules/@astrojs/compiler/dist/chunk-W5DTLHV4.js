		...
		let o = (t, e) => {
			...
			n = (t) => {
				let e = this.mem.getUint32(t + 0, !0),
					s = this.mem.getInt32(t + 4, !0);
				return e + s * 4294967296;
			},
			r = (t) => {
			...
			l = (t, e) => {
				...
				(i === void 0 &&
					((i = this._idPool.pop()),
					i === void 0 && (i = this._values.length),
					(this._values[i] = e),
			...
			u = (t) => {
				let e = n(t + 0),
					s = n(t + 8);
				return w.decode(new DataView(this._inst.exports.mem.buffer, e, s));
			},
		...
		this.importObject = {
			gojs: {
				...
				'syscall/js.valueCall': (t) => {
					...
					try {
						let e = r(t + 8),
							s = Reflect.get(e, u(t + 16)),
							i = f(t + 32),
							a = Reflect.apply(s, e, i);
