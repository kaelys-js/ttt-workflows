...
declare const UnparenthesizedPipeBodyDescriptions: Set<
	'AssignmentExpression' | 'ArrowFunctionExpression' | 'ConditionalExpression' | 'YieldExpression'
>;
...
declare const _default$5: {
	...
	PipeTopicUnconfiguredToken: ({ token }: { token: string }) => string;
	PipeTopicUnused: string;
	PipeUnparenthesizedBody: ({ type }: { type: UnparenthesizedPipeBodyTypes }) => string;
...
declare const _default$3: {
	AccessorIsGenerator: ({ kind }: { kind: 'get' | 'set' }) => string;
	...
	DuplicateExport: ({ exportName }: { exportName: string }) => string;
	...
	ForInOfLoopInitializer: ({ type }: { type: 'ForInStatement' | 'ForOfStatement' }) => string;
	ForInUsing: string;
	ForOfAsync: string;
	ForOfLet: string;
	GeneratorInSingleStatementContext: string;
	IllegalBreakContinue: ({ type }: { type: 'BreakStatement' | 'ContinueStatement' }) => string;
	IllegalLanguageModeDirective: string;
	IllegalReturn: string;
	ImportBindingIsString: ({ importName }: { importName: string }) => string;
	ImportCallArity: ({ phase }: { phase?: string | null }) => string;
	ImportCallNotNewExpression: ({ phase }: { phase?: string | null }) => string;
	ImportCallSpreadArgument: ({ phase }: { phase?: string | null }) => string;
	...
	InvalidDigit: ({ radix }: { radix: number }) => string;
	InvalidEscapeSequence: string;
	InvalidEscapeSequenceTemplate: string;
	InvalidEscapedReservedWord: ({ reservedWord }: { reservedWord: string }) => string;
	InvalidIdentifier: ({ identifierName }: { identifierName: string }) => string;
	InvalidLhs: ({ ancestor }: { ancestor: LValAncestor }) => string;
	InvalidLhsBinding: ({ ancestor }: { ancestor: LValAncestor }) => string;
	InvalidLhsOptionalChaining: ({ ancestor }: { ancestor: LValAncestor }) => string;
	InvalidNumber: string;
	InvalidOrMissingExponent: string;
	InvalidOrUnexpectedToken: ({ unexpected }: { unexpected: string }) => string;
	InvalidParenthesizedAssignment: string;
	InvalidPrivateFieldResolution: ({ identifierName }: { identifierName: string }) => string;
	InvalidPropertyBindingPattern: string;
	InvalidRestAssignmentPattern: string;
	LabelRedeclaration: ({ labelName }: { labelName: string }) => string;
	...
	MissingPlugin: ({ missingPlugin }: { missingPlugin: [string] }) => string;
	MissingOneOfPlugins: ({ missingPlugin }: { missingPlugin: string[] }) => string;
	MissingUnicodeEscape: string;
	MixingCoalesceWithLogical: string;
	ModuleAttributeInvalidValue: string;
	ModuleAttributesWithDuplicateKeys: ({ key }: { key: string }) => string;
	ModuleExportNameHasLoneSurrogate: ({
		surrogateCharCode,
	}: {
		surrogateCharCode: number;
	}) => string;
	ModuleExportUndefined: ({ localName }: { localName: string }) => string;
	...
	PrivateInExpectedIn: ({ identifierName }: { identifierName: string }) => string;
	PrivateNameRedeclaration: ({ identifierName }: { identifierName: string }) => string;
	...
	UnexpectedKeyword: ({ keyword }: { keyword: string }) => string;
	...
	UnexpectedReservedWord: ({ reservedWord }: { reservedWord: string }) => string;
	...
	VarRedeclaration: ({ identifierName }: { identifierName: string }) => string;
...
declare const _default$2: {
	StrictDelete: string;
	StrictEvalArguments: ({ referenceName }: { referenceName: string }) => string;
	StrictEvalArgumentsBinding: ({ bindingName }: { bindingName: string }) => string;
...
declare const _default$1: {
	...
	ParseExpressionExpectsEOF: ({ unexpected }: { unexpected: number }) => string;
};
...
interface EstreeTSEmptyBodyFunctionExpression
...
declare const JsxErrorTemplates: {
	...
	MissingClosingTagElement: ({ openingTagName }: { openingTagName: string }) => string;
...
declare const TSErrorTemplates: {
	AbstractMethodHasImplementation: ({ methodName }: { methodName: string }) => string;
	AbstractPropertyHasInitializer: ({ propertyName }: { propertyName: string }) => string;
	...
	DuplicateAccessibilityModifier: ({ modifier }: { modifier: Accessibility }) => string;
	DuplicateModifier: ({ modifier }: { modifier: TsModifier }) => string;
	EmptyHeritageClauseType: ({ token }: { token: 'extends' | 'implements' }) => string;
	...
	IncompatibleModifiers: ({ modifiers }: { modifiers: [TsModifier, TsModifier] }) => string;
	IndexSignatureHasAbstract: string;
	IndexSignatureHasAccessibility: ({ modifier }: { modifier: Accessibility }) => string;
	...
	InvalidHeritageClauseType: ({ token }: { token: 'extends' | 'implements' }) => string;
	...
	InvalidModifierOnTypeParameter: ({ modifier }: { modifier: TsModifier }) => string;
	InvalidModifierOnTypeParameterPositions: ({ modifier }: { modifier: TsModifier }) => string;
	...
	PrivateElementHasAccessibility: ({ modifier }: { modifier: Accessibility }) => string;
...
declare const FlowErrorTemplates: {
	...
	EnumInvalidExplicitTypeUnknownSupplied: ({ enumName }: { enumName: string }) => string;
	...
	EnumStringMemberInconsistentlyInitialized: ({ enumName }: { enumName: string }) => string;
...
type ParseErrorConstructor<ErrorDetails> = (
	loc: Position,
	pos: number,
...
type __ExtractMe = typeof _default$4 &
	typeof _default$3 &
	typeof _default$2 &
	typeof _default$1 &
	typeof _default &
...
type OptionsWithDefaults = Omit<Required<Options>, KeepOptionalKeys> &
