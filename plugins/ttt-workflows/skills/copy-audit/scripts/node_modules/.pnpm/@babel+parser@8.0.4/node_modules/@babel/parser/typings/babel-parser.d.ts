...
type ErrorInfoCompressed = {
	...
	DeclarationMissingInitializer: [{ kind: 'await using' | 'const' | 'destructuring' | 'using' }];
	...
	DecoratorAbstractMethod: [{ kind: 'abstract method' | 'abstract field' | 'declare field' }];
	...
	EnumInvalidMemberName: [{ enumName: string; memberName: string; suggestion: string }];
	...
	UnsupportedDeclareExportKind: [{ unsupportedExportKind: string; suggestion: string }];
