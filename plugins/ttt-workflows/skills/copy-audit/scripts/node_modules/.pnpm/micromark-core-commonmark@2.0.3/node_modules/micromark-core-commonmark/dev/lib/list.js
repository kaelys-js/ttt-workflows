...
function tokenizeListStart(effects, ok, nok) {
	...
	function endOfPrefix(code) {
		...
		self.containerState.size =
			initialSize + self.sliceSerialize(effects.exit(types.listItemPrefix), true).length;
		return ok(code);
	}
}
...
function tokenizeListItemPrefixWhitespace(effects, ok, nok) {
	...
	function afterPrefix(code) {
		...
		return !markdownSpace(code) && tail && tail[1].type === types.listItemPrefixWhitespace
			? ok(code)
			: nok(code);
	}
}
