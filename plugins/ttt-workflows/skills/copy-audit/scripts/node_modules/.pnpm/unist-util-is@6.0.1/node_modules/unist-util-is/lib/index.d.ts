 ...
 */
export const is: (<Condition extends ReadonlyArray<string>>(
	node: unknown,
	test: Condition,
	...
	(<Condition extends Array<string>>(
		node: unknown,
		test: Condition,
		index?: number | null | undefined,
		parent?: Parent | null | undefined,
	...
	(<Condition extends Props>(
		node: unknown,
		test: Condition,
		index?: number | null | undefined,
		parent?: Parent | null | undefined,
		context?: unknown,
	) => node is Node & Condition) &
	(<Condition extends TestFunction>(
		node: unknown,
		test: Condition,
		index?: number | null | undefined,
		parent?: Parent | null | undefined,
		context?: unknown,
	) => node is Node & Predicate<Condition, Node>) &
...
export type Test =
	...
	| ReadonlyArray<Props | TestFunction | string>
	| Props
	| TestFunction
	| string
	| null
