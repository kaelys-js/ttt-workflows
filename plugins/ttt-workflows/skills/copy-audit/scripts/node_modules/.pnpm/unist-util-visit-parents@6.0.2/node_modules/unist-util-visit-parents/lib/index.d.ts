 ...
 *   `unist-util-is`-compatible test.
 */
export function visitParents<Tree extends UnistNode, Check extends Test>(
	tree: Tree,
	check: Check,
 ...
 */
export type Parent<Tree extends UnistNode, Child extends UnistNode> = InternalParent<
 ...
 * Collect nodes in `Tree` that can be ancestors of `Child`.
 */
export type Ancestor<Tree extends UnistNode, Child extends UnistNode> = InternalAncestor<
	InclusiveDescendant<Tree>,
	Child
>;
/**
...
export type Visitor<
	...
	VisitedParents extends UnistParent = UnistParent,
 ...
 */
export type BuildVisitor<Tree extends UnistNode = UnistNode, Check extends Test = Test> = Visitor<
