 ...
 */
export function visit<Tree extends UnistNode, Check extends Test>(
	tree: Tree,
	check: Check,
...
export type Matches<Value, Check> =
	Check extends ReadonlyArray<any> ? MatchesOne<Value, Check[number]> : MatchesOne<Value, Check>;
/**
