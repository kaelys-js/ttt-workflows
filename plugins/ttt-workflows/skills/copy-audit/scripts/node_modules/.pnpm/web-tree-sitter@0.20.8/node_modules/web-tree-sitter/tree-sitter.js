var Module = void 0 !== Module ? Module : {},
	TreeSitter = (function () {
		var initPromise,
			document =
				'object' == typeof window ? { currentScript: window.document.currentScript } : null;
		class Parser {
			constructor() {
				this.initialize();
			}
					...
					(initPromise = new Promise((resolveInitPromise) => {
						...
						function createWasm() {
							...
							return (
								...
								'function' != typeof fetch
									? _(r)
									: fetch(wasmBinaryFile, { credentials: 'same-origin' }).then(function (t) {
						...
						var GOT = {},
							...
							GOTHandler = {
								get: function (e, t) {
									var r = GOT[t];
									return (
										r || (r = GOT[t] = new WebAssembly.Global({ value: 'i32', mutable: !0 })),
						...
						function getDylinkMetadata(e) {
							...
							if (e instanceof WebAssembly.Module) {
								...
								(0 === o.length && ((a = 'dylink'), (o = WebAssembly.Module.customSections(e, a))),
						...
						function asmjsMangle(e) {
							return 0 == e.indexOf('dynCall_') ||
								['stackAlloc', 'stackSave', 'stackRestore', 'getTempRet0', 'setTempRet0'].includes(
									e,
								)
								? e
								: '_' + e;
						...
						function sigToWasmTypes(e) {
							for (
								...
								(r.parameters.push(t[e[_]]), 'j' === e[_] && r.parameters.push('i32'));
							return r;
						}
									...
									(r.startsWith('orig$') && ((r = r.split('$')[1]), (t = !0)),
										...
										(t || 0 == GOT[r].value) &&
											('function' == typeof _
												...
												: 'number' == typeof _
													? (GOT[r].value = _)
													: err('unhandled export type for `' + r + '`: ' + typeof _)));
								}
						}
						...
						function resolveGlobalSymbol(e, t) {
							...
							return (
								...
								!r && e.startsWith('invoke_') && (r = createInvokeFunction(e.split('_')[1])),
								r
							);
						}
						...
						function loadWebAssemblyModule(binary, flags, handle) {
							...
							function loadModule() {
								...
								function postInstantiation(instance) {
									...
									return (
										init && (runtimeInitialized ? init() : __ATINIT__.push(init)), moduleExports
									);
								}
								if (flags.loadAsync) {
						...
						function loadDynamicLibrary(e, t, r) {
							...
							if (_)
								return (
									t.global &&
										!_.global &&
										((_.global = !0), 'loading' !== _.module && mergeLibSymbols(_.module, e)),
							...
							for (var _ = 1; _ <= 4; _ *= 2) {
								...
								if (
									...
									emscripten_realloc_buffer(
										Math.min(r, (s = Math.max(e, n)) + (((a = 65536) - (s % a)) % a)),
									))
								)
									return !0;
							}
						...
						var asmLibraryArg = {
							...
							_ts_query_new = (Module._ts_query_new = function () {
								return (_ts_query_new = Module._ts_query_new = Module.asm.ts_query_new).apply(
									null,
									arguments,
								);
							}),
							...
							_ts_tree_copy = (Module._ts_tree_copy = function () {
								return (_ts_tree_copy = Module._ts_tree_copy = Module.asm.ts_tree_copy).apply(
									null,
									arguments,
								);
							}),
							_ts_tree_delete = (Module._ts_tree_delete = function () {
								return (_ts_tree_delete = Module._ts_tree_delete = Module.asm.ts_tree_delete).apply(
									null,
									arguments,
								);
							}),
							...
							___cxa_atexit = (Module.___cxa_atexit = function () {
								return (___cxa_atexit = Module.___cxa_atexit = Module.asm.__cxa_atexit).apply(
									null,
									arguments,
								);
							}),
						...
						class Node {
							...
							get children() {
								if (!this._children) {
									...
									if (((this._children = new Array(e)), e > 0)) {
										let r = t;
										for (let t = 0; t < e; t++)
											((this._children[t] = unmarshalNode(this.tree, r)), (r += SIZE_OF_NODE));
										C._free(t);
									}
								}
							...
							get namedChildren() {
								if (!this._namedChildren) {
									...
									if (((this._namedChildren = new Array(e)), e > 0)) {
										let r = t;
										for (let t = 0; t < e; t++)
											((this._namedChildren[t] = unmarshalNode(this.tree, r)), (r += SIZE_OF_NODE));
										C._free(t);
									}
								}
							...
							get parent() {
								return (
									marshalNode(this), C._ts_node_parent_wasm(this.tree[0]), unmarshalNode(this.tree)
								);
							}
						...
						class TreeCursor {
							...
							get nodeTypeId() {
								return (
									marshalTreeCursor(this), C._ts_tree_cursor_current_node_type_id_wasm(this.tree[0])
								);
							}
							get nodeId() {
								return (
									marshalTreeCursor(this), C._ts_tree_cursor_current_node_id_wasm(this.tree[0])
								);
							}
							get nodeIsNamed() {
								return (
							...
							get nodeIsMissing() {
								return (
									marshalTreeCursor(this),
									1 === C._ts_tree_cursor_current_node_is_missing_wasm(this.tree[0])
								);
							}
							get nodeText() {
								marshalTreeCursor(this);
							...
							currentFieldId() {
								return (
									marshalTreeCursor(this), C._ts_tree_cursor_current_field_id_wasm(this.tree[0])
								);
							}
							currentFieldName() {
						...
						class Language {
								...
								if (!_) {
									...
									switch (t) {
										...
										case 4:
											...
											break;
										case 5:
											((s = new TypeError(`Bad pattern structure at offset ${_}: '${n}'...`)),
												(a = ''));
											break;
										default:
										...
										if (((s += SIZE_OF_INT), t === PREDICATE_STEP_TYPE_CAPTURE))
											...
											switch (t) {
												...
												case 'eq?':
													...
													if ('capture' === n[2].type) {
														...
														m[e].push(function (e) {
															let n, s;
															for (const r of e)
																(r.name === t && (n = r.node), r.name === _ && (s = r.node));
														...
														const t = n[1].name,
															_ = n[2].value;
														m[e].push(function (e) {
															for (const n of e) if (n.name === t) return (n.node.text === _) === r;
															return !0;
														});
													}
													break;
												...
												case 'match?':
													if (3 !== n.length)
														throw new Error(
															`Wrong number of arguments to \`#match?\` predicate. Expected 2, got ${n.length - 1}.`,
														);
													if ('capture' !== n[1].type)
														throw new Error(
													...
													m[e].push(function (e) {
														for (const t of e) if (t.name === _) return s.test(t.node.text) === r;
														return !0;
													});
													break;
												case 'set!':
													if (n.length < 2 || n.length > 3)
														throw new Error(
															`Wrong number of arguments to \`#set!\` predicate. Expected 1 or 2. Got ${n.length - 1}.`,
														);
												...
												case 'is-not?':
													if (n.length < 2 || n.length > 3)
														throw new Error(
															`Wrong number of arguments to \`#${t}\` predicate. Expected 1 or 2. Got ${n.length - 1}.`,
														);
													if (n.some((e) => 'string' !== e.type))
														throw new Error(
							...
							static load(e) {
								...
								const r =
									'function' == typeof loadSideModule ? loadSideModule : loadWebAssemblyModule;
								return t
									.then((e) => r(e, { loadAsync: !0 }))
									.then((e) => {
										const t = Object.keys(e),
											r = t.find(
												(e) => LANGUAGE_FUNCTION_REGEX.test(e) && !e.includes('external_scanner_'),
											);
										r ||
											console.log(
						...
						function unmarshalCaptures(e, t, r, _) {
							for (let n = 0, s = _.length; n < s; n++) {
								...
								((r += SIZE_OF_NODE), (_[n] = { name: e.captureNames[s], node: a }));
							}
							return r;
						}
