...
export declare function resolveFlowCollection(
	...
	| YAMLMap.Parsed<import('../index').ParsedNode, import('../index').ParsedNode | null>
	| YAMLSeq.Parsed<import('../index').ParsedNode>;
