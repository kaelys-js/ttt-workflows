...
need(
	...
	'ClickUp token',
	`reads/updates the ticket — read from ${tokenFile}`,
...
if (platform === 'github') {
	need(ghOk, 'gh (GitHub auth)', 'push the branch + open the PR', 'run:  gh auth login');
	...
	need(
		ghOk || azOk,
		'gh or az',
		'GitHub repos need gh; Azure DevOps repos need az',
